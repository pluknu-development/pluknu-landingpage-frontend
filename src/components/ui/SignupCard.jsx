...
function SignupCard() {
  return (
    <div className="flex w-full flex-col gap-8 rounded-[2rem] border border-white/70 bg-white p-8 shadow-[0_24px_80px_rgba(10,32,24,0.18)] max-md:gap-5 max-md:rounded-[1.6rem] max-md:p-5">
